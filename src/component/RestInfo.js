        ...
        <>
            ...
            <div className="flex justify-between w-full mb-2 pb-2">
                ...
                <div className="w-[70%]">
                    ...
                    <p className=""> {restData?.description} </p>
                </div>
                <div className="w-[20%] relative h-42 ">
                    <img className="w-60 h-36 object-cover rounded-2xl " src={"https://media-assets.swiggy.com/swiggy/image/upload/"+restData?.imageId}></img>
                    {
